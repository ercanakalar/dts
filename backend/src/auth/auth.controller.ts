...
import { ContextPublic, Public } from "src/common/decorators";
import {
    CreateUser,
    ForgotPassword,
    GiveRole,
...
import { GetContext } from "src/common/decorators/get-context.decorator";
...
export class AuthController {
    ...
    async register(@Body() user: CreateUser, @GetContext() contextId: number) {
        return await this.authService.register(user, contextId);
    }
